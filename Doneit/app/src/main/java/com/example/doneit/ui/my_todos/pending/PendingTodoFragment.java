package com.example.doneit.ui.my_todos.pending;
...
import com.example.doneit.ui.my_todos.MyTodosFragment;
...
public class PendingTodoFragment extends Fragment {
    ...
    private class MyTodosTask extends AsyncTask<Void,Void, List<Todo>> {
        ...
        protected List<Todo> doInBackground(Void... voids) {
            MyTodoService myTodoService = new MyTodoService(token, "pending");
